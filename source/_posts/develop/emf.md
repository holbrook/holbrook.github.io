...
![MDA关注度](/images/e4/MDA_in_googletrends.png)
...
![大一统建模标准](http://www.omg.org/mda/mda_audio/mda_rollovers/mda_left_new2.gif)

结果忙坏了厂商，兴奋了开发商，苦了用户和程序员。最终一场闹剧黯然收场，消失个干干静静。

其实抛开MDA的各种理想化的标准(如MOF、CWM等)，MDA提出了“从模型到模型”的软件开发周期：

![从模型到模型](/images/e4/MDA_lifecycle.jpg)
...
![四层模型](/images/e4/MDA_4_layers.png)
...
![模型编辑器](/images/e4/EMF_editor.png)
